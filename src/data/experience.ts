...
export const experienceData: TimelineItem[] = [
  ...
  },
  {
    ...
    description:
      "Developed and maintained production-grade web platforms with React, Node.js, and PostgreSQL. Collaborated with cross-functional teams to ship features faster, optimized application performance by 30%, and implemented CI/CD pipelines to streamline deployments.",
  },
  {
    title: "Full Stack Developer",

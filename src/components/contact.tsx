...
const Contact = () => {
  return (
    <section className="w-full px-4 py-20">
      ...
      <TitleWithSubtitle title="Contact Me" subtitle="Get In Touch" />
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div>
          ...
          <p className="text-zinc-600 text-sm dark:text-zinc-400 mb-8">
            I&apos;d love to hear about your project and how I can help. Feel
            free to reach out through any of the following contact methods or by
            using the form.
          </p>
          <ContactInfo />
        </div>
